          ...
          <div className=" grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 ">
            <div className="col-span-full lg:col-span-1">
              ...
              <a
                ...
                href="#"
              >
                Experience the magic of effortless Data Management with
                Immersive Dashboard.
              </a>
            </div>
            {/* <!-- End Col --> */}
              ...
              <div className="mt-3 grid space-y-3">
                <p>
                  <a
                    ...
                    href="#"
                  >
                    Please note that works in this collection are protected by
                    copyright law and copying, redistribution or sale, whether
                    or not for profit, by the recipient is not permitted unless
                    authorized by the rightsholder or by law.
                  </a>
                </p>
              </div>
            </div>
            ...
            <div className="col-span-2">
              ...
              <form>
                ...
                <p className="mt-3 text-sm text-@EBF2FA hover:text-white">
        ...
        <div className="max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-0.5 mx-auto">
          <div className="sm:mt-12 grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center">
            <div className="flex justify-between items-center">
              <p className="text-sm text-@EBF2FA hover:text-white">
                © 2023 Alterra Academy. All right reserved.
              </p>
            </div>
            {/* <!-- End Col --> */}
